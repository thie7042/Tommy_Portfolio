...
From the various models investigated within this research, the artificial neural network generated the most robust and consistent baseline strain datasets, allowing the digital twin to accurately visualise the footbridges structural response to loading. This analysis includes the derived strain, bending moment and deflection induced within the footbridge when subject to mechanical loading events. These metrics were validated further through a comparative finite element model, demonstrating the application of the digital twin relative to conventional FEM analysis. The value provided by this novel digital twin model may be realised through its ability to facilitate informed operational decisions and improve long-term structural integrity, serviceability and resourcefulness. 
